...
func TestDefaultRules(t *testing.T) {
	...
	rules := DefaultRules(map[string]string{"kubernetes_yum_version": "1.14.2-0", "kubernetes_deb_version": "1.14.2-00"})
	if len(rules) != 75 {
...
func TestUpgradeRules(t *testing.T) {
	...
	rules := UpgradeRules(map[string]string{"kubernetes_yum_version": "1.14.2-0", "kubernetes_deb_version": "1.14.2-00"})
	if len(rules) != 16 {
